...
features:
  - title: Cross-platform Support
    details: Compatible with Windows, Linux, and macOS systems, can be deployed and run on multiple operating systems.
  ...
  - title: Multiple Data Structures
    details: Compatible with multiple data structures including strings, sets, hashes, lists, and sorted sets to meet different business scenario requirements.
  ...
  - title: Data Persistence
    details: Provides RDB and AOF mechanisms to support data backup and recovery, ensuring data security and reliability.
  ...
  - title: High-performance Concurrency
    details: Has excellent processing speed and instant response capability, supporting concurrent creation and deletion of key-values in multiple threads.
  ...
  - title: Docker Deployment
    details: Provides Docker deployment method to simplify deployment process and facilitate containerized operations management.
    icon: <svg height="24" width="24" viewBox="0 -960 960 960" fill="var(--vp-c-blue-2)" xmlns="http://www.w3.org/2000/svg"><path d="M200-120v-60h80v-20h-80v-60h80v-20h-80v-60h80v-20h-80v-60h80v-20h-80v-60h80v-20h-80v-60h80v-20h-80v-60h80v-20h-80v-60h240v60h-160v20h160v60h-160v20h160v60h-160v20h160v60h-160v20h160v60h-160v20h160v60h-160v20h160v60H200Zm440-60h160v-60h-160v60Zm0-80h160v-60h-160v60Zm0-80h160v-60h-160v60Zm0-80h160v-60h-160v60Zm0-80h160v-60h-160v60Zm0-80h160v-60h-160v60Zm0-80h160v-60h-160v60Z"/></svg>
    link: /docs/guides/install
    linkText: Learn more
  - title: Protocol Compatibility
    details: Compatible with RESP protocol specifications, seamlessly integrates with existing Redis clients.
